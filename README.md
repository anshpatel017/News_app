...
A comprehensive Flutter news application with real-time news integration, user authentication, and modern UI design.

## 🚀 Features

### 📱 Core Functionality
- **Real-time News**: Integration with NewsAPI for live news content
- **User Authentication**: Secure signup/login via Supabase
- **Category Browsing**: Technology, Sports, Health, Business, Entertainment, Science
...
- **NewsAPI Integration**: Real news from 70,000+ sources
...
### 1. Clone Repository
```bash
git clone https://github.com/anshpatel017/News_app.git
...
2. Update `lib/config/news_api_config.dart`:
```dart
class NewsApiConfig {
...
Execute SQL in Supabase dashboard for bookmarks functionality:
```sql
-- Bookmarks table  
